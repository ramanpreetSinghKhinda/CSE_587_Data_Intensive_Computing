 ...
 *
 *           Part_2_Problem_3: Utilization of Buildings in UB over the years
 * 
 * @Input bina_classschedule2.csv
 * @Output <BuildingName, PercentageVacant>
 *
 **/
public class BuildingUtilization {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(BuildingUtilization.class);
		...
		job2.setJarByClass(BuildingUtilization.class);
